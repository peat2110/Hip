...
import views.html._
/**/
object garner_interference_proc extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template0[play.api.templates.HtmlFormat.Appendable] {
...
<table>
<tr>
<td><iframe src="iframe/garner_interference_proc_iframe.html" frameborder="0" width="750" height="350"></iframe></td></tr>

<tr>
<td align="right">
<br><a href="garner_interference_info.html" class="btn btn-block btn-lg btn-danger" style="padding:10px 5px"><span class="fui-arrow-left"></span> ย้อนกลับ</a>  &nbsp; 
          <a href="#" class="btn btn-block btn-lg btn-success" style="padding:10px 80px"><span class="fui-play"></span>&nbsp; เริ่มการทดลอง</a>
<br>
</td>
</tr>
</table>
...
<small >Faculty of Science and Technology, Thammasat University</small> <br>
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/intouch/Desktop/myProject/hipLab/app/views/garner_interference_proc.scala.html
                    HASH: 3112f401495d7b76dd9a9cec5cd30f3859c601a5
                    MATRIX: 874->0
                    LINES: 29->1
                    -- GENERATED --
                */
