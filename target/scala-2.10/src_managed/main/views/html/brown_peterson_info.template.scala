...
<tr>
<!-- Explanation -->
<td rowspan="2"><iframe src="iframe/brown_peterson_iframe.html" frameborder="0" width="450" height="350"></iframe></td>

<!-- Right Panel -->  
    <td align="center" style="padding-left:15px"><img src="../icon/brown_peterson.png" style="padding:20px 20px 20px 20px; height:120; width:120"><br><h6>Brown-Peterson Task</h6></td>
<!-- Buttons -->  
  <tr>
      <td style="padding-left:15px"><a href="home.html" class="btn btn-block btn-lg btn-danger" style="padding:10px 5px"><span class="fui-arrow-left"></span> ย้อนกลับ</a>  &nbsp; 
          <a href="brown_peterson_proc.html" class="btn btn-block btn-lg btn-primary"><span class="fui-arrow-right"></span> อ่านขั้นตอนการทดลอง</a>
  </tr>
</td>
</tr>
</table>
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/intouch/Desktop/myProject/Hip/app/views/brown_peterson_info.scala.html
                    HASH: 63b607b8026ba07f203e5718d9c78c3124d2a66c
                    MATRIX: 869->0
                    LINES: 29->1
                    -- GENERATED --
                */
