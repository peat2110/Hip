...
import views.html._
/**/
object attention_blink_info extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template0[play.api.templates.HtmlFormat.Appendable] {
...
<!-- Title -->    
<title>Human Information Processing Lab :: Attention Blink</title>
...
<tr>
<!-- Explanation -->
<td rowspan="2"><iframe src="iframe/attention_blink_iframe.html" frameborder="0" width="450" height="350"></iframe></td>

<!-- Right Panel -->  
    <td align="center" style="padding-left:15px"><img src="../icon/attention_blink.png" style="padding:20px 20px 20px 20px; height:120; width:120"><br><h6>Attention Blink</h6></td>
<!-- Buttons -->  
  <tr>
      <td style="padding-left:15px"><a href="home.html" class="btn btn-block btn-lg btn-danger" style="padding:10px 5px"><span class="fui-arrow-left"></span> ย้อนกลับ</a>  &nbsp; 
          <a href="attention_blink_proc.html" class="btn btn-block btn-lg btn-primary"><span class="fui-arrow-right"></span> อ่านขั้นตอนการทดลอง</a>
  </tr>
</td>
</tr>
</table>
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/intouch/Desktop/myProject/hipLab/app/views/attention_blink_info.scala.html
                    HASH: d6c857308684f90dad91e6269b4f6d1a23b5f429
                    MATRIX: 870->0
                    LINES: 29->1
                    -- GENERATED --
                */
