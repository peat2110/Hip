...
import views.html._
/**/
object signal_detection_info extends BaseScalaTemplate[play.api.templates.HtmlFormat.Appendable,Format[play.api.templates.HtmlFormat.Appendable]](play.api.templates.HtmlFormat) with play.api.templates.Template0[play.api.templates.HtmlFormat.Appendable] {
...
<!-- Title -->    
<title>Human Information Processing Lab :: Signal Detection</title>
...
<tr>
<!-- Explanation -->
<td rowspan="2"><iframe src="iframe/signal_detection_iframe.html" frameborder="0" width="450" height="350"></iframe></td>

<!-- Right Panel -->  
    <td align="center" style="padding-left:15px"><img src="../icon/signal_detection.png" style="padding:20px 20px 20px 20px; height:120; width:120"><br><h6>Signal Detection</h6></td>
<!-- Buttons -->  
  <tr>
      <td style="padding-left:15px"><a href="home.html" class="btn btn-block btn-lg btn-danger" style="padding:10px 5px"><span class="fui-arrow-left"></span> ย้อนกลับ</a>  &nbsp; 
          <a href="signal_detection_proc.html" class="btn btn-block btn-lg btn-primary"><span class="fui-arrow-right"></span> อ่านขั้นตอนการทดลอง</a>
  </tr>
</td>
</tr>
</table>
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Thu Jan 09 19:09:23 ICT 2014
                    SOURCE: /home/intouch/Desktop/myProject/Hip/app/views/signal_detection_info.scala.html
                    HASH: 22488a8462534a096477372d2681659d7f6dc809
                    MATRIX: 871->0
                    LINES: 29->1
                    -- GENERATED --
                */
